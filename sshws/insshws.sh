...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/Mahboub-power-is-back/multiws/refs/heads/master/sshws/ws-dropbear.service && chmod +x /etc/systemd/system/ws-dropbear.service
